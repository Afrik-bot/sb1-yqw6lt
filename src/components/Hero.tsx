        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="px-8 py-4 bg-purple-600 hover:bg-purple-700 text-white rounded-full font-medium transition-all transform hover:scale-105 inline-flex items-center justify-center gap-2">
                Start Your AI Journey
                <ArrowRight className="h-5 w-5" />
              </button>
              <button className="px-8 py-4 border border-purple-500/30 hover:border-purple-500 text-white rounded-full font-medium transition-all hover:bg-purple-500/10">
                View Case Studies
              </button>
            </div>
          </div>
